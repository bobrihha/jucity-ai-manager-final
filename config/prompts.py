...
• Именинник получает скидку 50% НА ВХОД (билет)! В ресторане скидок нет.
...
ДЛЯ РЕСТОРАНА (без минимума, именинник со скидкой 50% НА ВХОД):
Формула для билетов: все дети - 1 платят полную цену, именинник - 50% скидка НА БИЛЕТ
Скидка 50% только на ВХОДНОЙ БИЛЕТ! В ресторане скидок нет - еда оплачивается по меню.
Пример: "5 детей в субботу (ресторан) = 4 × 1590 + 1 × 795 (именинник -50% на билет) = 7 155 ₽ за входные билеты"
